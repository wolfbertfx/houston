...
> **Коммерческий R&D проект.** В открытом доступе публикуется контур сбора, ингеста и инфраструктурной обвязки. Ядро экспертной системы (аналитические алгоритмы, скоринг и логика `Fairways`) является закрытой интеллектуальной собственностью.

## Обзор архитектуры

Houston — это высокопроизводительная торговая система на базе потоковой обработки данных, предназначенная для ингеста котировок в реальном времени, склейки фьючерсов, тяжелой математической аналитики и трекинга жизненного цикла состояний.
