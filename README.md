...
* **Инфраструктура:** 
  ...
  * Grafana Loki (централизованный сбор логов из Docker для отладки пайплайна и своя легковесная панель мониторинга в Control/Console вместо тяжелой Grafana)
* **Гибридный контур:**
